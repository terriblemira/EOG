...
BLINK_THRESHOLD = 400            #M: 1st Default blink detection threshold, HIGH!!; initialized in init from eog_reader, just for redoing option (is replaced by new_default_blink threshold bf blink calibration)
